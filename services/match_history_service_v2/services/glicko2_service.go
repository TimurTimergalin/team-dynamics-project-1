...
func MakeGlicko2Service() Glicko2Service {
	return &glicko2ServiceImpl{tau: 0.5, epsilon: 1e-6}
}
...
func convertGameResult(result models.GameResult) glicko2.MatchResult {
	switch result {
	case models.Winner:
		return glicko2.MATCH_RESULT_WIN
	case models.DrawResult:
...
func (s *glicko2ServiceImpl) UpdateRatings(a, b *models.RatingInfo, result models.GameResult) (*models.RatingInfo, *models.RatingInfo) {
	...
	period.AddMatch(player1, player2, convertGameResult(result))
	period.Calculate()
