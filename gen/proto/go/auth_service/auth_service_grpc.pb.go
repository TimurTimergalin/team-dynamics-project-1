...
const (
	AuthService_AuthExternal_FullMethodName = "/auth_service.AuthService/AuthExternal"
	AuthService_Refresh_FullMethodName      = "/auth_service.AuthService/Refresh"
	AuthService_GetPublicKey_FullMethodName = "/auth_service.AuthService/GetPublicKey"
)
...
type AuthServiceClient interface {
	AuthExternal(ctx context.Context, in *AuthExternalRequest, opts ...grpc.CallOption) (*AuthExternalResponse, error)
...
func (c *authServiceClient) AuthExternal(ctx context.Context, in *AuthExternalRequest, opts ...grpc.CallOption) (*AuthExternalResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthExternalResponse)
	err := c.cc.Invoke(ctx, AuthService_AuthExternal_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	AuthExternal(context.Context, *AuthExternalRequest) (*AuthExternalResponse, error)
...
func (UnimplementedAuthServiceServer) AuthExternal(context.Context, *AuthExternalRequest) (*AuthExternalResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AuthExternal not implemented")
}
...
func _AuthService_AuthExternal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuthExternalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).AuthExternal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_AuthExternal_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).AuthExternal(ctx, req.(*AuthExternalRequest))
	}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "AuthExternal",
			Handler:    _AuthService_AuthExternal_Handler,
		},
		{
			MethodName: "Refresh",
