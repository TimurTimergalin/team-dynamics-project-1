...
from auth_sidecar import auth_sidecar_pb2 as auth__sidecar_dot_auth__sidecar__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in auth_sidecar/auth_sidecar_pb2_grpc.py depends on'
...
def add_AuthSidecarServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'auth_sidecar.AuthSidecar', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('auth_sidecar.AuthSidecar', rpc_method_handlers)
